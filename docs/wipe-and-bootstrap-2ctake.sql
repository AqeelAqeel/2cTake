-- ============================================================================
-- 2cTake — WIPE + FULL REBUILD (run ONCE in the target project's SQL editor)
-- WARNING: the first block DROPS the entire public schema (destroys the old
-- throwaway app). Everything else rebuilds 2cTake (001-013 + buckets).
-- Safe to re-run (drops guard the storage-schema policies too).
-- ============================================================================

-- ---------- 1. WIPE public schema + restore Supabase default grants ----------
...
-- ---------- 2. 2cTake schema (buckets + migrations 001-013) ----------
